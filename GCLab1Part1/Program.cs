    ...
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            input2 = Convert.ToInt32(Console.ReadLine());
                ...
                // Validation of user's input for number2
            ...
            Console.WriteLine();
            Console.WriteLine("The numbers in the hundreds place for each 3 digit number are {0} and {1}, respectively", firstnum1, firstnum2);
            secondnum1 = (input1 / 10) % 10;
            secondnum2 = (input2 / 10) % 10;
            Console.WriteLine("The numbers in the tens place for each 3 digit number are {0} and {1}, respectively", secondnum1, secondnum2);
            thirdnum1 = input1 % 10;
            thirdnum2 = input2 % 10;
            Console.WriteLine("The numbers in the ones place for each 3 digit number are {0} and {1}, respectively", thirdnum1, thirdnum2);
            Console.WriteLine();

            // Adding the ones, tens and hundreds places together
            ...
            // Calling the Result method and printing the result
            if (Result(total1, total2, total3) == true)
            {
                Console.WriteLine("True, the sum of the numbers in the ones, tens and hundreds place are all equal.");
            }
            else
            {
                Console.WriteLine("False, the sum of the numbers in the ones, tens and hundreds place are not equal.");
            }
        }
        // Declaring a method (Result) to determine if all three totals are the same
